...
### [ProjectControl Portfolio](https://github.com/monaka-77/project-control-portfolio)

複数プロジェクトのタスクを安全に一元管理するための、Python製ローカルファーストCLI＋静的HTMLダッシュボードの**就職活動向け公開版**です。
